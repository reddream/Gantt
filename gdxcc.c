/*  C code generated by apiwrapper for GAMS Version 24.7.3 */
...
{ int d_s[]={3,3,52,54}; printAndReturn(gdxDataErrorRecordX,3,int ) }
...
{ int d_s[]={3,3,55,59}; printAndReturn(gdxDataReadRawFastFilt,3,int ) }
...
{ int d_s[]={3,11,11}; printAndReturn(gdxRenameUEL,2,int ) }
